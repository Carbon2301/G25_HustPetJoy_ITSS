  ...
  return (
    <div className='w-full max-w-6xl m-5 '>
      ...
      <div className='bg-white border rounded text-sm max-h-[80vh] overflow-y-scroll'>
        <div className='hidden sm:grid grid-cols-[0.5fr_1fr_1fr_2.5fr_3fr_3fr_1fr] grid-flow-col py-3 px-6 border-b'>
          <p>#</p>
          <p>Pet</p>
          <p>Customer</p>
          <p>Date & Time</p>
        ...
        {appointments.map((item, index) => (
          <div className='flex flex flex-wrap justify-between max-sm:gap-2 sm:grid sm:grid-cols-[0.5fr_1fr_1fr_2.5fr_3fr_3fr_1fr] items-center text-gray-500 py-3 px-6 border-b hover:bg-gray-50' key={index}>
            ...
            <div className='flex items-center gap-2'>
              <img src={item.manager?.imgUrl} className='w-8 rounded-full bg-gray-200' alt="" /> <p>{item.manager?.name}</p>
            </div>
